...
// import { createInquiry } from "Services/inquiry"; // ⬅️ NEW service
...
//       brand: product.vehicleType === "Bike" ? product.bikeBrand : product.carBrand,
//     };
...
//     brand: {
//       "@type": "Brand",
//       name: product?.vehicleType === "Bike" ? product?.bikeBrand : product?.carBrand,
//     },
//     offers: {
//       "@type": "Offer",
...
//         <p className="vehicle">🚦 {product?.vehicleType}</p>

//         {product?.vehicleType === "Bike" && product?.bikeBrand && (
//           <p className="brand">🏍️ Brand: {product.bikeBrand}</p>
//         )}
//         {product?.vehicleType === "Car" && product?.carBrand && (
//           <p className="brand">🚘 Brand: {product.carBrand}</p>
//         )}
...
import { createWishlist } from "Services/wishlist"; // ⬅️ NEW service
...
export const ProductDetailComponent = () => {
  ...
  const handleAddToCart = () => {
    ...
    const cartData = {
      ...
      vehicleType: product.vehicleType,
      brand:
        product.vehicleType === "Bike" ? product.bikeBrand : product.carBrand,
    };
    ...
    <div className="product-detail-container">
      ...
      <Helmet>
        ...
        <meta
          property="og:description"
          content={
            product?.description || "Shop the best products at SHOPPER"
          }
        />
        <meta
          property="og:image"
