...
import {  getProducts } from "Services/product"; // alias
import { Helmet } from "react-helmet-async";
...
export const ProductsListComponent = () => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    name: `${type} Products `,
    description: `Explore our premium ${type} products at `,
    url: window.location.href,
  ...
  return (
    <div className="products-list-page">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content={`Discover the best ${type} products at . Quality and value for you.`}
        />
        <meta name="keywords" content={`${type}, ${type} products `} />

        {/* OpenGraph */}
        <meta property="og:title" content={`${type} Products `} />
        <meta
          property="og:description"
          content={`Check out the latest ${type} products at `}
        />
        <meta
          property="og:image"
          content={filteredProducts[0]?.photo || "/default-product.jpg"}
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.href} />
